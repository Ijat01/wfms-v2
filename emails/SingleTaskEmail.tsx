import {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Hr style={walletBottomLine} />
            ...
            <Text style={footerText}>
                For more information of the task, please log in to the system or contact individual responsible for this task assignation.
            </Text>
            <Text style={footerText}>
  ...
  export default SingleTaskEmail;
